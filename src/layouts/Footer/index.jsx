...
const index = () => {
  return (
    <div className="bg-gradient-to-bl from-black via-brand2 to-gray-900 pt-20">
        ...
        <div className="w-full px-8 mx-auto max-w-7xl">
          <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="grid justify-between grid-cols-2 gap-0 py-10 md:py-0">
              <ul>
                <p className="block mb-3 font-sans text-lg antialiased font-medium leading-normal text-blue-gray-900 opacity-40">Komunitas</p>
                <li>
              ...
              <ul>
                <p className="block mb-3 font-sans text-lg antialiased font-medium leading-normal text-blue-gray-900 opacity-40">Kelas Online</p>
                <li>
                  <a href="#" className="block py-1.5 font-sans text-base font-normal leading-relaxed text-gray-700 antialiased transition-colors hover:text-blue-gray-900">
                    Pendaftaran
                  </a>

export const menuItems = [
  ...
  },
  {
    ...
    child: [
      {
        childtitle: "Dashboard Subscription",
        childlink: "dashboard",
      },
      {
        childtitle: "Dashboard Financial",
        childlink: "crm",
      },
      {
        childtitle: "Dashboard Performance",
        childlink: "banking",
      },
    ],
  },
  {
    ...
    child: [
      {
        childtitle: "Partner",
        childlink: "subscription/partner",
      },
      {
        childtitle: "Partner KSO",
        childlink: "subscription/partner-kso",
      },
      {
        childtitle: "Instalation",
        childlink: "subscription/instalation",
      },
      {
        childtitle: "Company",
        childlink: "subscription/company",
      },
    ],
  },

  {
    title: "BTS Configuration",
    icon: "carbon:network-3",
    link: "/app/home",
    child: [
      {
        childtitle: "Room",
        childlink: "bts-config/room",
      },
      {
        childtitle: "Rack",
        childlink: "bts-config/rack",
      },
      {
        childtitle: "Switch Device",
        childlink: "bts-config/switch",
      },
      {
        childtitle: "Port",
        childlink: "bts-config/port",
      },
    ],
  },
  {
    ...
    child: [
      {
        childtitle: "Customer",
        childlink: "configuration/customer",
      },
      {
        childtitle: "Address",
        childlink: "configuration/address",
      },
      {
        childtitle: "Job Position",
        childlink: "configuration/job-position",
      },
      {
        childtitle: "Company Type",
        childlink: "configuration/company-type",
      },
    ],
  },
];

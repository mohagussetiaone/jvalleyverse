...
export function MetodePembelajaran() {
  ...
  return (
    <div className="bg-whiteSmoke dark:bg-primaryDark/80 to-gray-800 pt-24 pb-4 md:pb-0">
      ...
      <div className="py-4 md:py-8 grid grid-cols-1 lg:grid-cols-3 gap-4 w-auto px-4 md:px-8 xl:px-10 ">
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 h-full bg-gray-400 dark:bg-secondaryDark/80 min-h-[150px] lg:min-h-[250px]" className="cursor-pointer">
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[300px] bg-gray-800 dark:bg-secondaryDark/40">

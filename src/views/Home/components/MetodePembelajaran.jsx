      ...
      <div className="py-4 md:py-8 grid grid-cols-1 lg:grid-cols-3 gap-4 w-auto px-4 md:px-14 ">
        <WobbleCard containerClassName="col-span-1 lg:col-span-2 h-full bg-gray-400 dark:bg-brand-500 min-h-[150px] lg:min-h-[250px]" className="cursor-pointer">
          <div className="flex gap-4 flex-col md:flex-row">
            <div className="max-w-xs text-black dark:text-white">
              <h2 className="text-left text-balance text-xl lg:text-3xl font-semibold tracking-[-0.015em]">9 Batch sudah terselenggara</h2>
              <p className="mt-4 text-left  text-base/6">Lebih dari 100 orang telah mengikuti kelas Batch 9</p>
              <p className="mt-4 text-left underline text-base/6">Anda juga dapat mengikuti kelas!</p>
            </div>
            <div>
        ...
        <WobbleCard containerClassName="col-span-1 min-h-[300px] bg-gray-800 dark:bg-brand2" className="cursor-pointer">
          <div className="text-neutral-200">
            <h2 className="max-w-80  text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em]">Anda dapat mengikuti kelas</h2>
            <p className="mt-4 max-w-[26rem] text-left text-base/6">Kami telah menyediakan platform pelatihan secara daring agar anda dapat belajar melalui website</p>
            <p className="mt-4 max-w-[26rem] text-left text-base/6">
              <button className="bg-brand-500 text-white">Daftar sekarang</button>
            </p>
          </div>
        </WobbleCard>
      </div>

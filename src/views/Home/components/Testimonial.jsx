const Testimonial = () => {
  return (
    <>
      <section id="testimonies" className="py-20 bg-gradient-to-bl from-black via-brand2 to-black">
        <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="mb-12 space-y-5 md:mb-16 md:text-center">
              <h1 className="mb-5 text-3xl font-semibold text-white md:text-center md:text-4xl">Testimoni sahabat Jvalleyverse</h1>
              <p className="text-md text-gray-100 md:text-center md:text-2xl">Bagaimana mengulas dan memberi rating kepada kami</p>
            </div>
          </div>
                ...
                <div className="relative group">
                  ...
                  <a href="https://twitter.com/dan_schulman" className="cursor-pointer">
                    <div className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                      ...
                      <p className="leading-normal text-gray-300 text-md">Quam pellentesque nec nam aliquam sem et tortor consequat id. Enim sit amet venenatis urna cursus.</p>
                    </div>
                  </a>
                </div>
              </li>

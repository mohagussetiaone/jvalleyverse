  ...
  return (
    <div className="bg-gradient-to-tr w-screen from-black via-brand2 to-gray-900 py-4">
      <div className="flex flex-col gap-4 mb-12">
        <h2 className="text-3xl text-white font-bold">Jalur belajar Front End</h2>
        <p className="justify-center text-white px-[5%] md:px-[10%] xl:px-[20%]">Merancang antarmuka pengguna yang menarik dan responsif, belajar bagaimana mengubah desain menjadi halaman web yang menarik</p>
      </div>

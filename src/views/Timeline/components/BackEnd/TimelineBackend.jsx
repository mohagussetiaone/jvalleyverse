  ...
  return (
    <div className="bg-whiteSmoke dark:bg-gradient-to-tr w-screen from-black via-brand2 to-gray-900 py-4">
      <div className="flex flex-col gap-4 mb-12 text-black dark:text-neutral-200">
        ...
        <p className="justify-center px-[5%] md:px-[10%] xl:px-[20%]">Mengembangkan ilmu pemrograman backend dengan menggunakan server dan mengelola logika aplikasi di belakang layar sesuai dengan rancangan yang telah ditetapkan</p>
      </div>

const TimelineCard = () => {
  return (
    <div className="bg-whiteSmoke dark:bg-gradient-to-tr w-screen from-black via-primaryDark to-gray-900 py-4">
      <h2 className="text-3xl text-white font-bold mb-12">Silabus online</h2>

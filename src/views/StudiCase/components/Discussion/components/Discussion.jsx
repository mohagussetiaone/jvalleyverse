              ...
              <div key={item.id} className="grid grid-cols-5 border-t-2 px-2 md:px-4 cursor-pointer" onClick={() => handleDetailQuestion(item.id)}>
                <div className="col-span-1 flex flex-col items-center justify-center h-full py-4 relative">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <h3 className="bg-black py-1 px-2 rounded-lg whitespace-nowrap">{item.project.project_name}</h3>
                  </div>
                ...
                <div className="col-span-4 p-2 xl:p-4">
                  <div className="flex flex-col gap-1 md:gap-2 text-start">
                    ...
                    <p className="text-sm md:text-base xl:text-lg text-justify">{item.content}</p>
                  </div>

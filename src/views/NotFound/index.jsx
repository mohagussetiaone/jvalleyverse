...
const NotFound = () => {
  ...
  return (
    <div className="w-screen bg-gradient-to-tr from-black via-brand2 to-gray-900 h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">{t("Maaf, halaman yang anda cari tidak ditemukan")}</p>
        <Link to="/" className="flex items-center space-x-2 bg-brand-600 hover:bg-brand-700 hover:text-white text-gray-100 px-4 py-2 rounded transition duration-150" title="Return Home">
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        <svg className="w-full text-brand-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1120.59226 777.91584" xmlnsXlink="http://www.w3.org/1999/xlink">
          <title>not found</title>
          <circle cx="212.59226" cy="103" r="64" fill="#ff6532"></circle>
          <path
